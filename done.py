...
[COMMENT T&Z PSD TEAM BOT]

[My help]
[Bot]
[Me]
[Bot-Bot18「Contact Bot」]
[Gift-Gift3]
[Contact]
[Mid]
[All mid]
...
Idline: http://line.me/ti/p/~botline_12""",
    "lang":"JP",
    "comment":"AUTO LIKE NYA ZETSU Idline: http://line.me/ti/p/~botline_12 ",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    cl.sendText(msg.to,"Perubahan nama selesai " + string + "")
                ...
                if len(string.decode('utf-8')) <= 500:
                    ...
                    profile.statusMessage = string
                    ki18.updateProfile(profile)
                    cl.sendText(msg.to,"Perubahan status selesai " + string + "")
                if msg.text == "#Lurking":
...
#---------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki.updateProfile(profile)
                    ki.sendText(msg.to,"Nama berubah Menjadi :" + string + "")
#--------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki2.updateProfile(profile)
                    ki2.sendText(msg.to,"Nama berubah Menjadi :" + string + "")
#--------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki3.updateProfile(profile)
                    ki3.sendText(msg.to,"Nama berubah Menjadi :" + string + "")
#--------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki4.updateProfile(profile)
                    ki4.sendText(msg.to,"Nama berubah Menjadi :" + string + "")
                ...
                if len(string.decode('utf-8')) <= 500:
                    ...
                    profile.statusMessage = string
                    cl.updateProfile(profile)
                    cl.sendText(msg.to,"Merubah Bio👉" + string + "")
#--------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki5.updateProfile(profile)
                    ki5.sendText(msg.to,"Nama berubah Menjadi :" + string + "")
#--------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki6.updateProfile(profile)
                    ki6.sendText(msg.to,"Nama berubah Menjadi :" + string + "")
#--------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki7.updateProfile(profile)
                    ki7.sendText(msg.to,"Nama berubah Menjadi :" + string + "")
#--------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki8.updateProfile(profile)
                    ki8.sendText(msg.to,"Nama berubah Menjadi :" + string + "")
#--------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki9.updateProfile(profile)
                    ki9.sendText(msg.to,"Nama berubah Menjadi :" + string + "")
#--------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki10.updateProfile(profile)
                    ki10.sendText(msg.to,"Nama berubah Menjadi :" + string + "")
#--------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki11.updateProfile(profile)
                    ki11.sendText(msg.to,"Nama berubah Menjadi :" + string + "")
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki12.updateProfile(profile)
                    ki12.sendText(msg.to,"Nama berubah Menjadi :" + string + "")
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki13.updateProfile(profile)
                    ki13.sendText(msg.to,"Nama berubah Menjadi :" + string + "")
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki14.updateProfile(profile)
                    ki14.sendText(msg.to,"Nama berubah Menjadi :" + string + "")
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki15.updateProfile(profile)
                    ki15.sendText(msg.to,"Nama berubah Menjadi :" + string + "")
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki16.updateProfile(profile)
                    ki16.sendText(msg.to,"Nama berubah Menjadi :" + string + "")
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki17.updateProfile(profile)
                    ki17.sendText(msg.to,"Nama berubah Menjadi :" + string + "")
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki18.updateProfile(profile)
                    ki18.sendText(msg.to,"Nama berubah Menjadi :" + string + "")
#--------------------------------------------------------
                ...
                cl.sendText(msg.to, "%f speed test server" % (elapsed_time))
                ...
                msg.contentMetadata = {'mid': ki18mid}
                ki18.sendMessage(msg)
            elif msg.text.lower() == 'alan outall':
                gid = cl.getGroupIdsJoined()
                ...
                for i in gid:
                    ...
                    ki18.leaveGroup(i)
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"PSD T&Z TEAM BOT PAMIT DARI SEMUA ROOM\nNANTI AKU DATANG LAGI")
                else:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"membuka QR dilakukan")
                    else:
                        cl.sendText(msg.to,"Tidak dapat digunakan untuk kelompok")
...
#-----------------------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                klist=[ki,k2,k3,ki4,ki5,ki6,ki7,ki8,ki9,ki10]
                                kicker=random.choice(klist)
                                random.choice(KAC).kickoutFromGroup(msg.to,[target])
                                print (msg.to,[g.mid])
                            except:
...
#-----------------------------------------------------------
                ...
                if wait["blacklist"] == {}:
                    ...
                    cl.sendText(msg.to,mc)
            elif cms(msg.text, ["Result","result"]):
                    if msg.to in wait['readPoint']:
                        ...
                        wait['ROM'][msg.to] = {}
                        print wait
                        cl.sendText(msg.to, hemphhhhhhhhhhhh ")
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        cl.sendText(msg.to,"􀠁􀆩􏿿Bye Bye semua "  +  str(ginfo.name)  + "")
